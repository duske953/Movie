...
})({"eab82":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "d954c6d2ad3f463a";
...
var _lozadDefault = parcelHelpers.interopDefault(_lozad);
"use strict";
...
const movieTrailerBox = document.querySelector(".movie-section__trailer-container");
const cardImg = document.querySelectorAll(".lazy-img");
const overlay = document.querySelector(".overlay");
const trailerClosebox = document.querySelector(".movie-section__trailer-close-box");
const menuIcon = document.querySelector(".icon-menu");
const form = document.querySelector(".nav__form");
const errBox = document.querySelector(".err-box");
(0, _jqueryDefault.default)(heroContainer).slick({
    autoplay: true,
    infinite: true,
    speed: 300,
    slidesToShow: 1,
...
function gotToCarousel() {
    ...
    (0, _jqueryDefault.default)(heroContainer).slick("slickGoTo", slideIndex, true);
}
gotToCarousel();
function setBackgroundImg() {
    let slideIndex = (0, _jqueryDefault.default)(heroContainer).slick("slickCurrentSlide");
    const posterPath = heroSectionBox[slideIndex].querySelector(".hero-section__img-box").firstElementChild.getAttribute("data-poster");
    heroSection.style.background = `linear-gradient(to left, rgb(52, 58, 64), rgba(33, 37, 41, 0.644)),url(${posterPath})`;
    return slideIndex;
}
if (heroContainer && heroSectionBox) setBackgroundImg();
(0, _jqueryDefault.default)(heroContainer).on("afterChange", ()=>{
...
if (overlay) overlay.addEventListener("click", ()=>{
    movieTrailerBox.classList.remove("movie-section__trailer-container--active");
    overlay.classList.remove("overlay--active");
});
if (trailerClosebox) trailerClosebox.addEventListener("click", ()=>{
    movieTrailerBox.classList.remove("movie-section__trailer-container--active");
    movieTrailerBox.querySelector("iframe").setAttribute("src", movieTrailerBox.querySelector("iframe").getAttribute("src"));
    overlay.classList.remove("overlay--active");
});
...
},{"jquery":"hgMhh","slick-carousel":"ghMFH","lozad":"j31H6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
// Pass this if window is not defined yet
    ...
    var preferredDoc = document1, pushNative = push1;
    (function() {
        var i1, Expr, outermostContext, sortInput, hasDuplicate, push = pushNative, // Local document vars
        document, documentElement, documentIsHTML, rbuggyQSA, matches1, // Instance-specific data
        ...
        unloadHandler = function() {
            ...
            return elem.disabled === true && nodeName1(elem, "fieldset");
        }, {
            dir: "parentNode",
            next: "legend"
        });
        ...
        try {
            push.apply(arr1 = slice.call(preferredDoc.childNodes), preferredDoc.childNodes);
            // Support: Android <=4.0
        ...
        function find1(selector, context, results, seed) {
                ...
                if (documentIsHTML) {
                    ...
                    if (nodeType !== 11 && (match = rquickExpr.exec(selector))) {
                        ...
                        if (m = match[1]) {
                            ...
                            // getElementById can match elements by name instead of ID
                            if (newContext && (elem = newContext.getElementById(m)) && find1.contains(context, elem) && elem.id === m) {
                                push.call(results, elem);
                                return results;
                            }
                        // Type selector
 ...
 */ function createInputPseudo(type) {
            return function(elem) {
                return nodeName1(elem, "input") && elem.type === type;
            };
        }
        /**
 ...
 */ function createButtonPseudo(type) {
            return function(elem) {
                return (nodeName1(elem, "input") || nodeName1(elem, "button")) && elem.type === type;
            };
        }
        /**
 ...
 */ function setDocument(node1) {
            var subWindow, doc = node1 ? node1.ownerDocument || node1 : preferredDoc;
            ...
            matches1 = documentElement.matches || documentElement.webkitMatchesSelector || documentElement.msMatchesSelector;
            // Support: IE 9 - 11+, Edge 12 - 18+
	...
	---------------------------------------------------------------------- */ // Document order sorting
            sortOrder = function(a, b) {
                ...
                if (compare & 1 || !support.sortDetached && b.compareDocumentPosition(a) === compare) {
                    ...
                    // two documents; shallow comparisons work.
                    // eslint-disable-next-line eqeqeq
                    if (a === document || a.ownerDocument == preferredDoc && find1.contains(preferredDoc, a)) return -1;
                    // Support: IE 11+, Edge 17 - 18+
                    // IE/Edge sometimes throw a "Permission denied" error when strict-comparing
                    // two documents; shallow comparisons work.
                    // eslint-disable-next-line eqeqeq
                    if (b === document || b.ownerDocument == preferredDoc && find1.contains(preferredDoc, b)) return 1;
        ...
        find1.matches = function(expr, elements) {
            return find1(expr, null, null, elements);
        };
        find1.matchesSelector = function(elem, expr) {
            setDocument(elem);
            ...
            return find1(expr, document, null, [
                elem
            ]).length > 0;
        };
        find1.contains = function(context, elem) {
 ...
 */ jQuery.uniqueSort = function(results) {
        ...
        Expr = jQuery.expr = {
			...
			*/ match[1] = match[1].toLowerCase();
                    if (match[1].slice(0, 3) === "nth") {
                        ...
                        if (!match[3]) find1.error(match[0]);
                        // numeric x and y parameters for Expr.filter.CHILD
                        // remember that false/true cast respectively to 0/1
                        match[4] = +(match[4] ? match[5] + (match[6] || 1) : 2 * (match[3] === "even" || match[3] === "odd"));
                        match[5] = +(match[7] + match[8] || match[3] === "odd");
                    // other types prohibit arguments
                    } else if (match[3]) find1.error(match[0]);
                    return match;
                },
            ...
            filter: {
                TAG: function(nodeNameSelector) {
                    ...
                    return nodeNameSelector === "*" ? function() {
                        ...
                        return nodeName1(elem, expectedNodeName);
                    };
                },
                ...
                ATTR: function(name, operator, check) {
                    return function(elem) {
                        var result = find1.attr(elem, name);
                        ...
                        if (parent) {
                            ...
                            if (simple) {
                                while(dir){
                                    node = elem;
                                    while(node = node[dir]){
                                        if (ofType ? nodeName1(node, name) : node.nodeType === 1) return false;
                                    }
                            ...
                            if (forward && useCache) {
                                ...
                                if (diff === false) {
                                    ...
                                    while(node = ++nodeIndex && node && node[dir] || (diff = nodeIndex = 0) || start.pop())if ((ofType ? nodeName1(node, name) : node.nodeType === 1) && ++diff) {
                ...
                PSEUDO: function(pseudo, argument) {
                    ...
                    var args, fn = Expr.pseudos[pseudo] || Expr.setFilters[pseudo.toLowerCase()] || find1.error("unsupported pseudo: " + pseudo);
            ...
            pseudos: {
                ...
                has: markFunction(function(selector) {
                    return function(elem) {
                        return find1(selector, elem).length > 0;
                    };
                }),
                ...
                lang: markFunction(function(lang) {
                    ...
                    if (!ridentifier.test(lang || "")) find1.error("unsupported lang: " + lang);
                ...
                checked: function(elem) {
                    ...
                    return nodeName1(elem, "input") && !!elem.checked || nodeName1(elem, "option") && !!elem.selected;
                },
                ...
                button: function(elem) {
                    return nodeName1(elem, "input") && elem.type === "button" || nodeName1(elem, "button");
                },
                text: function(elem) {
                    var attr;
                    return nodeName1(elem, "input") && elem.type === "text" && ((attr = elem.getAttribute("type")) == null || attr.toLowerCase() === "text");
                },
        ...
        function tokenize(selector, parseOnly) {
            ...
            return soFar ? find1.error(selector) : // Cache the tokens
        ...
        function addCombinator(matcher, combinator, base) {
            ...
            function(elem, context, xml) {
                ...
                if (xml) {
                    ...
                    while(elem = elem[dir])if (elem.nodeType === 1 || checkNonElements) {
                        outerCache = elem[expando] || (elem[expando] = {});
                        if (skip && nodeName1(elem, skip)) elem = elem[dir] || elem;
        ...
        function multipleContexts(selector, contexts, results) {
            ...
            for(; i < len; i++)find1(selector, contexts[i], results);
            return results;
        }
 ...
 */ function select(selector, context, results, seed) {
        ...
        find1.compile = compile;
        find1.select = select;
        find1.setDocument = setDocument;
        find1.tokenize = tokenize;
        find1.escape = jQuery.escapeSelector;
        find1.getText = jQuery.text;
        find1.isXML = jQuery.isXMLDoc;
        find1.selectors = jQuery.expr;
        find1.support = jQuery.support;
        find1.uniqueSort = jQuery.uniqueSort;
    /* eslint-enable */ })();
 ...
 */ jQuery.Callbacks = function(options) {
    ...
    function completed1() {
        ...
        window.removeEventListener("load", completed1);
        jQuery.ready();
    }
    ...
    window.setTimeout(jQuery.ready);
        ...
        window.addEventListener("load", completed1);
    }
    ...
    if (documentElement1.getRootNode) isAttached = function(elem) {
 ...
 */ jQuery.event = {
    ...
    (function() {
        ...
        function computeStyleTests() {
            ...
            documentElement1.appendChild(container).appendChild(div);
        ...
        jQuery.extend(support, {
            ...
            reliableTrDimensions: function() {
                ...
                if (reliableTrDimensionsVal == null) {
                    ...
                    documentElement1.appendChild(table).appendChild(tr).appendChild(trChild);
                    trStyle = window.getComputedStyle(tr);
                    reliableTrDimensionsVal = parseInt(trStyle.height, 10) + parseInt(trStyle.borderTopWidth, 10) + parseInt(trStyle.borderBottomWidth, 10) === tr.offsetHeight;
                    documentElement1.removeChild(table);
                }
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        !support.reliableTrDimensions() && nodeName1(elem, "tr") || // Fall back to offsetWidth/offsetHeight when value is "auto"
    ...
    function schedule() {
        if (inProgress) {
            if (document1.hidden === false && window.requestAnimationFrame) window.requestAnimationFrame(schedule);
        ...
        attrHooks: {
            type: {
                set: function(elem, value) {
                    if (!support.radioValue && value === "radio" && nodeName1(elem, "input")) {
                        var val = elem.value;
    ...
    jQuery.extend(jQuery.event, {
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !special.noBubble && !isWindow(elem)) {
                ...
                if (tmp === (elem.ownerDocument || document1)) eventPath.push(tmp.defaultView || tmp.parentWindow || window);
            }
...
},{"jquery":"hgMhh"}],"j31H6":[function(require,module,exports) {
...
* Copyright (c) 2020 Apoorv Saxena; Licensed MIT */ !function(t, e) {
   ...
   * @const {boolean}
   * @private
   */ var g1 = "undefined" != typeof document && document.documentMode, f = {
        rootMargin: "0px",
        threshold: 0,
        load: function(t) {
            if ("picture" === t.nodeName.toLowerCase()) {
                var e = t.querySelector("img"), r = !1;
                null === e && (e = document.createElement("img"), r = !0), g1 && t.getAttribute("data-iesrc") && (e.src = t.getAttribute("data-iesrc")), t.getAttribute("data-alt") && (e.alt = t.getAttribute("data-alt")), r && t.append(e);
            }
    ...
    return function() {
        var r, a, o = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ".lozad", t1 = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, e1 = Object.assign({}, f, t1), i = e1.root, n = e1.rootMargin, d = e1.threshold, u = e1.load, g = e1.loaded, s = void 0;
        "undefined" != typeof window && window.IntersectionObserver && (s = new IntersectionObserver((r = u, a = g, function(t2, e) {
...
},{}]},["eab82","hE5Xp"], "hE5Xp", "parcelRequire8b71")
